...
class A7U:
    ...
    @staticmethod
    def obj_func_4(x: list[npt.NDArray[np.float64]]) -> npt.NDArray[np.float64]:
        x1 = x[0]
        x2 = x[1]
        x3 = x[2]
        x4 = x[3]
    ...
    @staticmethod
    def obj_func_der_4(x: list[npt.NDArray[np.float64]]) -> npt.NDArray[np.float64]:
        x1 = x[0]
        x2 = x[1]
        x3 = x[2]
        x4 = x[3]
    ...
    def g1(x):
        x1, x2, x3, x4 = x
        return (-x2[0] + 3 * x2[1] - 2 * x2[2] + x2[3] + 3 * x2[4] - 4 + x3[0] - 3 * x3[4] + 2 * x4[2])[0]
